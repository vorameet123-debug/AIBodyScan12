      ...
      <div className="relative container mx-auto px-6 max-w-7xl">
        ...
        >
          ...
          <div className="flex items-center gap-4">
            ...
            >
              {/* Glow effect */}
              <div className="absolute inset-0 bg-gradient-to-br from-indigo-400 to-purple-600 rounded-2xl blur-xl opacity-60" />
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <motion.div
              ...
              className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-indigo-500/20 to-purple-500/20 backdrop-blur-sm rounded-full border border-indigo-500/30"
            >
