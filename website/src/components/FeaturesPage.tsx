...
export const FeaturesPage: React.FC = () => {
  ...
  const colorClasses: Record<string, { bg: string; text: string; border: string; gradient: string }> = {
    violet: { bg: 'bg-violet-500', text: 'text-violet-400', border: 'border-violet-500/30', gradient: 'from-violet-500 to-violet-600' },
    fuchsia: { bg: 'bg-fuchsia-500', text: 'text-fuchsia-400', border: 'border-fuchsia-500/30', gradient: 'from-fuchsia-500 to-fuchsia-600' },
    purple: { bg: 'bg-purple-500', text: 'text-purple-400', border: 'border-purple-500/30', gradient: 'from-purple-500 to-purple-600' },
    indigo: { bg: 'bg-indigo-500', text: 'text-indigo-400', border: 'border-indigo-500/30', gradient: 'from-indigo-500 to-indigo-600' },
    blue: { bg: 'bg-blue-500', text: 'text-blue-400', border: 'border-blue-500/30', gradient: 'from-blue-500 to-blue-600' },
    cyan: { bg: 'bg-cyan-500', text: 'text-cyan-400', border: 'border-cyan-500/30', gradient: 'from-cyan-500 to-cyan-600' },
  };
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-gradient-to-br from-violet-950/40 to-transparent rounded-full blur-3xl" />
        <div className="absolute bottom-1/3 left-0 w-[500px] h-[500px] bg-gradient-to-br from-fuchsia-950/30 to-transparent rounded-full blur-3xl" />
      </div>
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          ...
          >
            <motion.span
              ...
              className="inline-flex items-center gap-2 px-4 py-1.5 bg-gradient-to-r from-violet-500/10 to-fuchsia-500/10 text-violet-400 rounded-full text-sm font-semibold mb-6 border border-violet-500/20"
            >
                  ...
                  <div className={`flex flex-col ${isEven ? 'lg:flex-row' : 'lg:flex-row-reverse'} gap-8 lg:gap-16 items-center`}>
                    ...
                    <div className="flex-1 w-full max-w-lg">
                      ...
                      >
                        ...
                        {/* Card */}
                        <div className={`relative bento-card p-8 md:p-10 border-2 ${colors.border}`}>
                          <div className="text-center">
                            ...
                            <p className="text-slate-400 text-sm">{feature.tagline}</p>
      ...
      <section className="relative py-24">
        <div className="container mx-auto px-6 max-w-4xl">
          <motion.div
            ...
            viewport={{ once: true }}
            className="relative bg-gradient-to-br from-slate-800 via-slate-800 to-slate-900 rounded-[2rem] p-10 md:p-14 overflow-hidden text-center border border-slate-700/50"
          >
            {/* Decorative */}
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <motion.button
                  ...
                  className="group flex items-center gap-2 bg-gradient-to-r from-violet-500 to-fuchsia-500 hover:from-violet-600 hover:to-fuchsia-600 text-white font-bold py-4 px-8 rounded-xl shadow-xl hover:shadow-2xl transition-all"
                >
