...
export default {
  ...
  theme: {
    extend: {
      ...
      colors: {
        // Premium accent - Electric Violet / Blurple
        accent: {
          50: '#eef2ff',
          100: '#e0e7ff',
          200: '#c7d2fe',
      ...
      backgroundImage: {
        'mesh-gradient': 'radial-gradient(ellipse at top right, var(--tw-gradient-stops))',
        'mesh-gradient-bl': 'radial-gradient(ellipse at bottom left, var(--tw-gradient-stops))',
