...
export const Model3DViewer: React.FC<Model3DViewerProps> = ({
  ...
  return (
    <motion.div
      ...
      className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl p-6 shadow-lg overflow-hidden"
    >
      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-xl p-4 overflow-y-auto max-h-96">
          <h4 className="font-semibold text-gray-700 mb-4 text-sm">Click to Highlight</h4>
              ...
              return (
                <motion.button
                  ...
                  className={`w-full px-3 py-2 rounded-lg transition-all text-left text-sm ${
                    selectedPart === part
                      ? 'bg-red-100 border-2 border-red-500 font-semibold text-red-700'
                      : 'bg-gray-100 border-2 border-gray-200 hover:border-primary-300 text-gray-700'
                  }`}
                >
