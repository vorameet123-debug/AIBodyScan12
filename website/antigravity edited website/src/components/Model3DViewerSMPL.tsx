    ...
    >
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-2">
          <Maximize2 className="text-primary-600" size={24} />
          <h3 className="text-xl font-bold text-gray-800">3D Body Model</h3>
        </div>
        <button
          onClick={handleResetView}
          className="flex items-center gap-1 px-3 py-1.5 bg-primary-100 hover:bg-primary-200 text-primary-600 rounded-lg transition text-sm font-medium"
        >
          <RotateCw size={14} />
          Reset View
        </button>
      ...
      {/* 3D Canvas */}
      <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl overflow-hidden shadow-md relative">
        <div
          ref={containerRef}
      ...
      <div className="mt-4 text-xs text-gray-600 bg-gradient-to-r from-blue-50 to-purple-50 p-3 rounded-lg flex items-center gap-2 border border-blue-100">
        <span>✨</span>
