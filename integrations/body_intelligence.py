...
class BodyIntelligence:
    ...
    def _build_query_conditions(self, user_id: int, person_name: str | None = None):
    ...
    def _get_measurement(self, measurements: dict, key: str) -> float | None:
        """
    ...
    def get_measurement_history(self, user_id: int, days: int = 90, person_name: str | None = None) -> list[dict]:
    ...
    def calculate_trends(self, user_id: int, lookback: int = 5, person_name: str | None = None) -> dict:
    ...
    def detect_shape_changes(self, user_id: int, person_name: str | None = None) -> list[str]:
    ...
    def get_latest_vs_first(self, user_id: int, person_name: str | None = None) -> dict:
    ...
    def get_progress_summary(self, user_id: int, person_name: str | None = None) -> dict:
    ...
    def classify_body_shape(self, user_id: int, person_name: str | None = None) -> dict:
    ...
    def detect_shape_changes(self, user_id: int, person_name: str | None = None) -> list[dict]:
    ...
    def detect_body_patterns(self, user_id: int, person_name: str | None = None) -> list[dict]:
    ...
    def calculate_trend_velocity(self, user_id: int, person_name: str | None = None) -> dict:
